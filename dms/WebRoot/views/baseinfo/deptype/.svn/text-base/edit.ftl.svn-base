...
<html xmlns="http://www.w3.org/1999/xhtml">	
	<head>
		...
		<script type="text/javascript">
        	function formSubmit() {
				...
				$.post(url, {'pmBscDeptType.vcTypeName': vcTypeName, 'pmBscDeptType.pid': pId}, function(jsonObj) {
					if(jsonObj.timeout) {
	...
	<body>
		<div class="iner_title_name"><strong>系统管理>>代码维护>>机构性质修改</strong></div>
		<div class="iner_title_sub_03">
			<a href="javascript:doCancel();" class="return" >返回</a>
		</div>
		<@s.set name="formUrl" value="'/baseinfo/deptype/editDepType.action'" />
		<#include "form.ftl" />
	</body>
</html>		
