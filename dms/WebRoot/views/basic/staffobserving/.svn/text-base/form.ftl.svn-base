<form id="staffForm" method="post" action="${contextPath}<@s.property value="#formUrl" escape="false"/>">
	...
	<table cellpadding="0" cellspacing="0" class="form_table" style="margin-bottom:10px;">
		...
		<tr>
	      <th colspan="4" width="80%" style="text-align:center;"><strong>新增人员立功表彰</strong></th>
	      <th width="20%">&nbsp;</th>
	    </tr>
	    <tr>
			    <th>人员属性：</th>
	    ...
	    <tr>
			<th>立功、受表彰时间：</th>
			<td>
				<input type="text" name="pmBscObservingStaff.vcObservTime" dataType="Require" msg= "请选择立功、受表彰时间" class="add_input form_input" 
				readonly id="vcObservTime" onclick="displayCalendar('',document.getElementById('vcObservTime'),'yyyy-mm-dd', this)" require="true" dataType="Require"  trim="true"  
		...
		<tr>
			<th>备注：</th>
			<td colspan="3">
				<textarea id="vcmemo" name="pmBscObservingStaff.vcRemark" 
