...
<html xmlns="http://www.w3.org/1999/xhtml">	
	...
	<body>
		<div class="iner_title_name"><strong>人员信息管理>>人员信息管理>>人员属性变动>>${typeName}变动>>个人${typeName}变动查看</strong></div>
		...
		<table cellpadding="0" cellspacing="0" class="form_table" style="margin-bottom:10px;">
			 <tr>
			  ...
			  <tr>
			    ...
			    <th>调动时间：</th>
			    <td><@s.date name="staffRank.vcChgDate" format="yyyy-MM-dd"/>&nbsp;</td>
			  </tr>
			  <tr>
			    <th>备注：</th>
			    <td colspan="3">
					<@s.property value="staffRank.vcRemark" escape="false" />&nbsp;
				</td>
			  </tr>
			  <tr>
			    <td>&nbsp;</td>
