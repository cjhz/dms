...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
        	...
        	function show(staffId) {
        		var url = '${contextPath}/basic/staffChange/show.action?' + param + '&staffId=' + staffId;
	...
	<body>
		<div class="iner_title_name"><strong>人员信息管理>>人员调动管理>>人员调动查看</strong></div>
		<#include "../../common/msg_panel.ftl" />
		<div class="iner_title_sub_03">
			<form id="staffForm" action="${contextPath}/basic/staffChange/chgstaff_page_query.action" method="post">
		...
		<div class="iner_title">
			<@s.url var="pageUrl" value="/basic/staffChange/chgstaff_page_query.action" escapeAmp="false">   
