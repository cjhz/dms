...
function Dialog(title, content, width, height, cssName, closeHanlder) {
	this.title = title;
	this.content = content;
	this.width = width;
	this.height = height;
	this.cssName = cssName;
	this.closeHanlder = closeHanlder;
	var temp_float = new String;
	if (!document.getElementById("floatBoxBg")) {
		temp_float = "<div id=\"floatBoxBg\" style=\"height:" + $(document).height() + "px;filter:alpha(opacity=50);opacity:0;\"></div>";
