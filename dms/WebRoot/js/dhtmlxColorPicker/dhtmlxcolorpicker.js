...
X = (document.compatMode!="BackCompat"?"X":"");
   if (!this.fullview) {
	   ...
	   html += "</td></tr>";
	   html += "</table>";
	   html += "<table class='cs_ButtonsPanel' cellpadding='0' cellspacing='0' style='width:100%;'><tr><td style='width:100%;'><input tabindex='9' class='cs_ButtonCancel' csid='cs_ButtonCancel' type='button' value='"+this.language.btnCancel+"' /><input tabindex='8' class='cs_ButtonOk' csid='cs_ButtonOk' type='button' value='"+this.language.btnSelect+"' /><input tabindex='10' class='cs_ButtonOk' csid='cs_ButtonClear' type='button' value='"+this.language.btnClear+"' /></td></tr></table>";
...
dhtmlXColorPicker.prototype._initEvents = function()
{
   ...
   this.elements['cs_ButtonClear'].z = this;
   this.elements['cs_ButtonClear'].onclick = this.clickClear;
   this.elements['cs_ButtonClear'].onmouseover = this.hoverButton;
   this.elements['cs_ButtonClear'].onmouseout = this.normalButton;
}
...
dhtmlXColorPicker.prototype.clickClear = function(ev)
{
   var z = this.z;
  z.callEvent ("onSelect", ['']);
